function [t,u]=cranknic(F,tspan,y0,Nh)
%CRANKNIC Crank-Nicolson method for integrating IVPs on uniform mesh
% [t,u] = cranknic(F,tspan,y0,Nh);
% INPUT:
